       ...
       setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        ...
        login.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e) {
                ...
                {
                	JOptionPane.showMessageDialog(login," Please enter all login details");
                }
        ...
        fpass.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e) {
                EventQueue.invokeLater(new Runnable() {
                    public void run() {
                        try {
                            Forgot_passA frame = new Forgot_passA();
                             frame.setVisible(true);
                        } catch (Exception e) {
 ...
 class LoginA extends JFrame {
   ...
   public LoginA() {
       ...
       setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        ...
        JLabel lblNewUserRegister = new JLabel("   Admin login   ");
        lblNewUserRegister.setForeground(java.awt.Color.white);
        lblNewUserRegister.setFont(new Font("Times New Roman", Font.BOLD, 25));
        lblNewUserRegister.setBounds(220, 12, 250, 70);
        contentPane.add(lblNewUserRegister);
        ...
        JLabel lblName = new JLabel("Enter Admin ID: ");
        lblName.setForeground(java.awt.Color.white);
        lblName.setFont(new Font("Tahoma", Font.PLAIN, 16));
        lblName.setBounds(58, 138, 99, 43);
        contentPane.add(lblName);
        ...
        login.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e) {
                ...
                String pwd=null;
                try {
                    String sql = "select * from tadmin where id="+Id;
                    p = con.prepareStatement(sql);
                    rs = p.executeQuery();
                    if (rs.next()){
                         DID = rs.getString("id");
